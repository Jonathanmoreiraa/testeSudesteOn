 ...
 * @var \App\Model\Entity\User[]|\Cake\Collection\CollectionInterface $products
 */
?>
<?php use Cake\Routing\Router;?>
<div class="d-flex">
        <div class="mr-auto p-2">
            <h2 class="display-4 titulo">Listar Defensivos Agrícolas</h2>
        </div>
    <a href="cadastrar.html">
        <div class="p-2">
        <?= $this->Html->link(__('Cadastrar'), ['controller' => 'products', 'action'=>'add'], ['class'=>'btn btn-outline-info btn-sm'])?>
        </div>
    </a>
</div>
    ...
    <table class="table table-striped table-hover table-bordered">
        <thead>
            <tr>
                <th>ID</th>
                <th>Nome</th>
                <th>Lote</th><!--oculta o e-mail quando está na tela xs-->
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($product->lote) ?></td>
                <td class="d-none d-sm-table-cell"><?= h($product->created) ?></td>
